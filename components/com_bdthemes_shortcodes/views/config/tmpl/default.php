    ...
    <div id="su-generator">
        <div id="su-generator-header">
            <div class="su-search-wrapper">
                <a href="http://goo.gl/jIskpZ" target="_blank" title="<?php echo JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_NEED_HELP_DESC') ?>" class="su-help-link"><?php echo JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_NEED_HELP') ?></a>
