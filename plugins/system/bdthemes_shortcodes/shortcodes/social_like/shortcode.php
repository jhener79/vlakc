        ...
        if($atts['button'] == 'vk') {
            if (BDT_SU_VKID != '') {
                $return .= "<div class='sl_vk sl_button'>";
                    ...
                    $return .= '<script type="text/javascript">VK.init({apiId:'.BDT_SU_VKID.', onlyWidgets: true});</script>';
                ...
                $return .= alert_box(JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SL_VK_ERROR'), 'warning');
            }
        }    
