        ...
        return array(
            ...
            'atts'     => array(
                ...
                'size' => array(
                    ...
                    'step'    => 10,
                    'default' => 200,
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PROGRESS_PIE_SIZE'),
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PROGRESS_PIE_SIZE_DESC'),
                    'child'   => array(
                        'line_width' => array(
                            'type'    => 'slider',
                            'min'     => 1,
                        ...
                        'show_scale' => array(
                            'type'    => 'bool',
                            'default' => 'yes',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PROGRESS_PIE_SCALE'), 
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PROGRESS_PIE_SCALE_DESC')
                        )
                    )
                ),
                'bar_color' => array(
                    ...
                    'child'     => array(
                        ...
                        'scale_color' => array(
                            'type'    => 'color',
                            'default' => '#dddddd',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_PROGRESS_PIE_SCALE_COLOR'),
