...
class Su_Shortcode_user_content_config extends Su_Data {
    ...
    static function get_config() {
        ...
        return array(
            ...
            'atts'  => array(
                'message' => array(
                    'default' => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_USER_CONTENT_DEFAULT_MESSAGE'),
            ...
            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_USER_CONTENT_DEFAULT_MESSAGE_DESC'),
            'icon'    => 'lock'
        );
    }
