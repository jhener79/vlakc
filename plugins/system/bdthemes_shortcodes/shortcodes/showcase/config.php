...
class Su_Shortcode_showcase_config extends Su_Data {
    ...
    static function get_config() {
        ...
        return array(
            'name'  => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE'),
            ...
            'atts'  => array(
                ...
                'show_more' => array(
                    'type'    => 'bool',
                    'default' => 'no',
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_SHOW_MORE'),
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_SHOW_MORE_DESC'),
                    'child'   => array(
                ...
                'filter' => array(
                    ...
                    'child'   => array(
                        'filter_deeplink' => array(
                            'type'    => 'bool',
                            'default' => 'no',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_FILTER_DEEPLINK'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_FILTER_DEEPLINK_DESC')
                        ),
                        'page_deeplink' => array(
                            'type'    => 'bool',
                            'default' => 'no',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_PAGE_DEEPLINK'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_PAGE_DEEPLINK_DESC')
                        ),
                        'filter_style' => array(
                            'type'       => 'select',
                            'values'     => array(
                            ...
                            'default' => '1',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_FILTER_STYLE'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_FILTER_STYLE_DESC')
                        ),
                ...
                'popup_position' => array(
                    ...
                    'default' => 'below',
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POPUP_POSITION'), 
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POPUP_POSITION_DESC'),
                    'child'   => array(
                        'popup_category' => array(
                            'type'    => 'bool',
                            'default' => 'yes',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_POPUP_CATEGORY'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_POPUP_CATEGORY_DESC'),  
                        ),
                        'popup_date' => array(
                            'type'    => 'bool',
                            'default' => 'yes',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_POPUP_DATE'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_POPUP_DATE_DESC')
                        ),
                        'popup_image' => array(
                            'type'    => 'bool',
                            'default' => 'yes',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_POPUP_IMAGE'),
                ...
                'include_article_image' => array(
                    'type'    => 'bool',
                    'default' => 'no',
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_INCLUDE_ARTICLE_IMAGE'),
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_SHOWCASE_INCLUDE_ARTICLE_IMAGE_DESC'),
                    'child'   => array(
                        'medium' => array(
                            'type'    => 'slider',
                            'min'     => 1,
