        ...
        return array(
            ...
            'atts'  => array(
                ...
                'show_more' => array(
                    'type'    => 'bool',
                    'default' => 'no',
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_SHOW_MORE'),
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_SHOW_MORE_DESC'),
                    'child'   => array(
                ...
                'filter' => array(
                    ...
                    'child'   => array(
                        'filter_style' => array(
                            ...
                            'default' => '1',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_FILTER_STYLE'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_FILTER_STYLE_DESC')
                        ),
                        'filter_deeplink' => array(
                            'type'    => 'bool',
                            'default' => 'no',
                            'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_FILTER_DEEPLINK'),
                            'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_FILTER_DEEPLINK_DESC')
                        ),
                ...
                'include_article_image' => array(
                    'type'    => 'bool',
                    'default' => 'no',
                    'name'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_INCLUDE_ARTICLE_IMAGE'),
                    'desc'    => JText::_('PLG_SYSTEM_BDTHEMES_SHORTCODES_POST_GRID_INCLUDE_ARTICLE_IMAGE_DESC'),
                    'child'   => array(
                        'medium' => array(
                            'type'    => 'slider',
                            'min'     => 1,
