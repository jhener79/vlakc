...
class suAsset {
	...
	public static function tmplURI($shortcode) {
		$tmplPath = JURI::root().'templates/'.BDT_SU_CTMPL.'/html/plg_bdthemes_shortcodes/shortcodes/'.$shortcode;
		return $tmplPath;
	}
	...
	public static function tmplPath($shortcode) {
		$tmplPath = JPATH_ROOT.DIRECTORY_SEPARATOR.'templates'.DIRECTORY_SEPARATOR.BDT_SU_CTMPL.DIRECTORY_SEPARATOR.'html'.DIRECTORY_SEPARATOR.'plg_bdthemes_shortcodes'.DIRECTORY_SEPARATOR.'shortcodes'.DIRECTORY_SEPARATOR.$shortcode;
		return $tmplPath;
	}
