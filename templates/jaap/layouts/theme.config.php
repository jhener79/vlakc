...
foreach ($positions as $position) {
    ...
    if ($this['config']->get("grid.{$position}.padding", false)) {
        $wrapper_classes[$position][] = "tm-padding-".$this['config']->get("grid.{$position}.padding");
    }
...
$body_classes .= ' navbar-'.$this['config']->get('navbar');
...
//$this['asset']->addFile('css', 'css:static.css');
$this['asset']->addFile('css', 'css:custom.css');

if (file_exists(JPATH_ROOT.'/components/com_hikashop/hikashop.php')) {
    $this['asset']->addFile('css', 'css:hikashop.css');
}
...
if ($this['config']->get('smoothscroll')) {
    $this['asset']->addFile('js', 'js:SmoothScroll.js');
}
