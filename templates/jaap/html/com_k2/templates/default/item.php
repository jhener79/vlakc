...
<div id="k2Container" class="itemView ItemBlog<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="blog-content-block">
	    ...
	    <div class="itemImageBlock">
		  	<div class="itemImage">
			  	<a class="modal" data-uk-light-box="" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
			  	...
			  	<div class="blog-info-block">
					...
					?>
					<span class="catItemDateCreated" data-uk-tooltip title="<?php echo $createYear; ?>">				
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
		    	...
		    	<a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>">
