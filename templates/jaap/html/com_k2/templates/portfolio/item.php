	...
	<div class="uk-grid" data-uk-grid>
		<div class="blog-content-block uk-width-medium-2-3">
		    ...
		    <div class="itemToolbar">
			    <?php if($this->item->params->get('itemCategory') || $this->item->params->get('catItemDateCreated') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments')): ?>
		...
		<div class="uk-width-medium-2-3">
			...
			<a name="itemCommentsAnchor" id="itemCommentsAnchor"></a>
			  ...
			  <?php $user = JFactory::getUser(); if ($this->item->params->get('comments') == '2' && $user->guest): ?>
			  		<div class="uk-alert uk-alert-warning uk-alert-large uk-margin-top"><?php echo JText::_('K2_LOGIN_TO_POST_COMMENTS'); ?></div>
			  <?php endif; ?>
		  	</div>
		  	<?php endif; ?>
			...
			<div class="itemBackToTop">
				<a class="k2Anchor readon" href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>">
