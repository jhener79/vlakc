...
<fieldset>
	...
	<div class="tm-toolbar" style="float: right;margin-top: 20px;">
			...
			<tr>
				...
				?>
						<a href="<?php echo hikashop_completeLink('cart&task=newcart&cart_type='.$cart_type.$Itemid_str); ?>">
							<span class="uk-icon-cart-plus" title="<?php echo JText::_('NEW_CART'); ?>">
							</span>
						</a>
				<?php
					}elseif($cart_type == 'wishlist' && $this->config->get('enable_multicart')){
				?>
						<a href="<?php echo hikashop_completeLink('cart&task=newcart&cart_type='.$cart_type.$Itemid_str); ?>">
							<span class="uk-icon-heart" title="<?php echo JText::_('NEW_WISHLIST'); ?>">
							</span>
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option='.HIKASHOP_COMPONENT.'&view=user&layout=cpanel'.$Itemid_str); ?>" >
						<span class="uk-icon-arrow-left" title="<?php echo JText::_('HIKA_BACK'); ?>">
						</span>
					</a>
				</td>
				<?php } ?>
...
<form action="<?php echo hikashop_completeLink('cart'); ?>" method="post"  name="adminForm" id="adminForm">
	...
	<table id="hikashop_cart_listing" class="hikashop_carts adminlist table table-striped table-hover" cellpadding="1">
		<thead>
			<tr>
				<th class="hikashop_cart_num_title title titlenum uk-text-center">
					<?php echo JText::_( 'HIKA_NUM' );?>
				</th>
				<th class="hikashop_cart_name_title title uk-text-center">
					<?php echo JText::_('CART_PRODUCT_NAME'); ?>
				</th>
				<th class="hikashop_cart_quantity_title title uk-text-center">
					<?php echo JText::_('PRODUCT_QUANTITY'); ?>
				</th>
				<th class="hikashop_cart_price_title title uk-text-center">
					<?php echo JText::_('PRODUCT_PRICE'); ?>
				</th>
				<th class="hikashop_cart_modified_title title uk-text-center">
					<?php echo JText::_('HIKA_LAST_MODIFIED'); ?>
				</th>
				<th class="hikashop_cart_current_title title uk-text-center">
					<?php echo JText::_('HIKA_CURRENT'); ?>
				</th>
				<th class="hikashop_cart_delete_title title uk-text-center">
