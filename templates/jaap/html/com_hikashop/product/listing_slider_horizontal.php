...
try{
	...
	var fx_".$this->params->get('main_div_name')."_".$this->row->product_id." = new Fx.Style('product_".$this->params->get('main_div_name')."_".$this->row->product_id."', 'margin-left', {
		duration: ".$duration.",
		transition: Fx.Transitions.".$productTransition.",
		wait: true
	});
...
?>
<div class="hikashop_horizontal_slider" id="window_<?php echo $this->params->get('main_div_name'); ?>_<?php echo $this->row->product_id;  ?>" style="margin: auto; <?php echo $cursor; ?> height:<?php echo $height; ?>px; width:<?php echo $width; ?>px; overflow:hidden; position:relative" <?php echo $htmlLink; ?>" >
 	<div id="product_<?php echo $this->params->get('main_div_name'); ?>_<?php echo $this->row->product_id;  ?>" style="height:<?php echo $height; ?>px; width:<?php echo $width*2; ?>px; " >
