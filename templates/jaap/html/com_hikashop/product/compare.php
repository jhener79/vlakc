...
<table class="hikashop_compare_table">
	...
	foreach($this->elements as $k => $element) { ?>
		<td class="hikashop_compare_details_prod_column">
			...
			<div id="hikashop_product_<?php echo $element->product_id; ?>_price_main" class="hikashop_product_price_main tm-product-detail-item">
				<?php
				$this->row =& $element;
			...
			<span class="hikashop_product_weight_main tm-product-detail-item">
			...
			<span class="hikashop_product_width_main tm-product-detail-item">
			...
			<span class="hikashop_product_length_main tm-product-detail-item">
			...
			<span class="hikashop_product_height_main tm-product-detail-item">
