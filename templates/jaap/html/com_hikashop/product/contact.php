...
if(!empty($this->product)) {
	...
	echo @$this->title;
		...
		<div class="toolbar" id="toolbar" style="float: right;">
			<button class="readon" type="button" onclick="checkFields();"><i class="uk-icon-check"></i> <?php echo JText::_('OK'); ?></button>
<?php if(JRequest::getCmd('tmpl', '') != 'component') { ?>
			<button class="readon" type="button" onclick="history.back();"><i class="uk-icon-remove"></i> <?php echo JText::_('HIKA_CANCEL'); ?></button>
<?php } ?>
		</div>
...
?>
			...
			<dd id="hikashop_contact_value_altbody" class="hikashop_contact_item_value">
				<textarea id="hikashop_contact_altbody" cols="60" rows="50" name="data[contact][altbody]" style="width:100%; min-height: 100px;"><?php
