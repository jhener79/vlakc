...
?>
<div class="uk-grid tm-product-main-block" data-uk-grid-match>
	...
	<div id="hikashop_product_right_part" class="hikashop_product_right_part uk-width-medium-1-2 tm-product-details">
		<?php
			echo "<div class=\"tm-product-pagination\">";
			if(!empty($this->links->previous))
				echo "<a title='".JText :: _('PREVIOUS_PRODUCT')."' href='".$this->links->previous."' class=\"Previous\"></a>";
			if(!empty($this->links->next))
				echo "<a title='".JText :: _('NEXT_PRODUCT')."' href='".$this->links->next."' class=\"Next\"></a>";
			echo "</div>";
		?>
		<h1 class="title">
