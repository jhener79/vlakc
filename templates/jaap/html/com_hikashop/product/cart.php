...
if(empty($this->rows)){
	...
	if(!empty($desc) || $desc == '0'){
		...
		<div id="hikashop_cart" class="hikashop_cart">
			<span class="tm-hs-cart-empty"><i class="uk-icon-shopping-cart"></i> <?php echo $desc; ?></span>
		</div>
<?php
	}
} else { ?>
<div id="hikashop_cart" class="hikashop_cart">
	<div class="tm-hs-total">
		<?php
				$this->row=$this->total;
				...
				if($cart_type != 'wishlist') {
					...
					<a class="hikashop_small_cart_checkout_link" href="<?php echo $url_checkout; ?>">
						...
						<div class="hikashop_small_cart_total_title"><?php echo $text; ?></div>
					</a><?php
