...
<script type="text/javascript">
	...
	function setToCompareList(product_id,name,elem) {
		...
		if( compare_list[product_id] ) {
			...
			if( nn == 'a' )
				elem.innerHTML = "<span class='tm-hs-acompare'><?php echo JText::_('ADD_TO_COMPARE_LIST'); ?></span>";
		} else {
			if(compare_list.length < <?php echo $this->config->get('compare_limit',5); ?> ) {
				...
				var nn = elem.nodeName.toLowerCase();
				if( nn == 'a' )
					elem.innerHTML = "<span class='tm-hs-rcompare'><?php echo JText::_('REMOVE_FROM_COMPARE_LIST');?></span>";
			} else {
