...
<div id="hikashop_download_listing">
	...
	<fieldset>
		<table cellpadding="1" width="100%">
			<thead>
				<tr>
					<th class="hikashop_product_name title uk-text-center"><?php
					...
					?></th>
					<th class="hikashop_file_name title uk-text-center"><?php
						echo JHTML::_('grid.sort', JText::_('HIKA_FILES'), 'f.file_name', $this->pageInfo->filter->order->dir,$this->pageInfo->filter->order->value );
					?></th>
					<th class="hikashop_nb_download title uk-text-center"><?php
						echo JText::_('NB_DOWNLOADED');
					?></th>
					<th class="hikashop_download_limit title uk-text-center"><?php
					...
					?></th>
					<th class="hikashop_order_date_title title uk-text-center"><?php
