...
<fieldset class="adminform">
	<div class="header hikashop_header_title" ><h1><?php echo JText::_('AFFILIATE');?></h1></div>
	<div class="tm-toolbar" id="toolbar" style="float: right;margin-top: 20px;">
		<table>
			<tr>
				<td>
					<a onclick="submitbutton('apply'); return false;" href="#" >
						<span class="uk-icon-check" title="<?php echo JText::_('HIKA_APPLY'); ?>">
						</span>
					</a>
				</td>
				<td>
...
<div id="page-affiliate">
	<table style="width:100%">
		<tr>
			<td valign="top" width="50%" class="tm-adminform-left">
<?php } else { ?>
...
<?php } ?>
				<fieldset class="adminform">
					...
					<table class="hikashop_affiliate_table">
						<tr>
							<td class="key">
...
<?php if(!HIKASHOP_RESPONSIVE) { ?>
			...
			<td valign="top" width="50%" class="tm-adminform-right">
<?php } else { ?>
	</div>
	<div class="span6">
<?php } ?>
					...
					<?php if($this->advanced_stats){ ?>
							<span id="affiliate_all_clicks">
								...
								echo $this->popup->display(
										JText::_('CLICKS_ALL').'<span class="uk-icon-check"></span> ',
										'CLICKS_ALL',
...
<?php } ?>
	...
	<fieldset class="adminform">
		<legend><?php echo JText::_('MAIN_INFORMATION'); ?></legend>
		<table class="hikashop_affiliate_table" cellspacing="1" width="100%">
			<tr>
				<td class="key">
					<label for="data[user][user_partner_activated]">
						<?php echo JText::_( 'AFFILIATE_ACCOUNT_ACTIVE' ); ?>
