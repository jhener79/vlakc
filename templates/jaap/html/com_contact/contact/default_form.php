	...
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
		...
		<div class="row-fluid">
			...
			<?php if ($this->params->get('show_email_copy')) { ?>
				<div class="control-group">
					<div class="contact_email_copy"><?php echo $this->form->getInput('contact_email_copy'); ?> <?php echo $this->form->getLabel('contact_email_copy'); ?></div>
				</div>
             </div>
             </div>
			<?php } ?>
			...
			<?php foreach ($this->form->getFieldsets() as $fieldset): ?>
				...
				<?php endif ?>
			<?php endforeach;?>
			<div class="form-action"><button class="readon validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
