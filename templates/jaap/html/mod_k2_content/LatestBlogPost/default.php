...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="latest-blog-post k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
      ...
      <div class="item-meta">
        ...
        <?php if($params->get('itemDateCreated')): ?>
          <span class="moduleItemDateCreated"><i class="uk-icon-clock-o"></i> <?php echo JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC4')); ?></span>
        <?php endif; ?>
